...
ALLOWED_USERS = [578389883, 548230563, 1013144293, 802816696, 780630634, 557360156, 590117683, 480485095]
SUPPORT_EMAIL = ""
TELEGRAM_BOT_TOKEN = ""
        ...
        try:
            ...
            for conv in messages:
                ...
                if (msg['from_id'] in ALLOWED_USERS and 
                    ...
                    response = f"""Здравствуйте, {user_name}, в связи с веденными ограничениями в отношении Камиллы Хаитовой и ее подруг (то есть, вас) от 24 февраля 2025 г., вам запрещается писать в личные сообщения, для связи используйте {SUPPORT_EMAIL}

Версия Python: {sys.version}
Uptime: {self.get_uptime()}
Сервис ПО "Защита информации от Камиллы Хаитовой" """
