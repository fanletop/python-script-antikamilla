...
# Настройки
BOT_TOKEN = '8261480996:AAEXvx5952ce2PAtBFtWheAXkimx4PAyh10'
ALLOWED_USERS = [1570952050]  # ID разрешенных пользователей Telegram
VK_TOKENS = ['']  # Токены VK аккаунтов
ALLOWED_VK_IDS = [578389883, 548230563, 1013144293, 802816696, 780630634, 557360156, 590117683, 480485095]  # ID VK пользователей, которых можно банить/разбанить
